...
public static	double totalPrice;
	...
	public Ticket(String name, String ID, String carriage, String pn, double disco, int flightN, double dist, String disability)
	{
		NAME = name;
		id = ID;
		CL = carriage;
	...
	public static void purchaseTicket() {
		...
		Airplane.addTicket(name, id, clss, pn, disc, Airplane.generateRandomFNum(), dist, dis);
