		...
		ticketPurchaseBtn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				classCombo.addSelectionListener(new SelectionAdapter() {
					...
					double totalPrice;
							totalPrice = MainWindow2.fullPrice;
						
						if(classCombo.getText().equalsIgnoreCase("First"))
							MainWindow2.fullPrice = ((Ticket.firstMod*flightDistance) - discount);
						
						else if(classCombo.getText().equalsIgnoreCase("Business"))
							MainWindow2.fullPrice = ((Ticket.businessMod*flightDistance) - discount);
						
						else if(classCombo.getText().equalsIgnoreCase("Economy"))
							MainWindow2.fullPrice = ((Ticket.econMod*flightDistance) - discount);
						...
						destCombo.addSelectionListener(new SelectionAdapter() {
							...
							if(classCombo.getText() != "" && destCombo.getText() != "") {
								...
								priceLabel.setText("Total Price: $" + (decForm.format(MainWindow2.fullPrice)));
							}
						}
						});
						...
						addPassBtn.addSelectionListener(new SelectionAdapter() {
							@Override
							public void widgetSelected(SelectionEvent e) {
								double distance = MainWindow2.flightDistance;
								double totalPrice = MainWindow2.fullPrice;
								Airplane.addTicket(nameText.getText(), IDText.getText(), classCombo.getText(), pnText.getText(), discount, Airplane.generateRandomFNum(), MainWindow2.flightDistance , requestLabel.getText());
